...
namespace Football_Web
{
    public partial class OverUnderModel
    {
        ...
        /// <summary>
        /// model output class for OverUnderModel.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("OverUnderModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("IsOver25");
            if (labelColumn == null)
            {
                throw new Exception("IsOver25 column not found. Make sure the name searched for matches the name in the schema.");
            }
